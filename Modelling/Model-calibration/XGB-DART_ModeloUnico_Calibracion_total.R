...
saveRDS(model_log_general, file= "model.log_XGB-DART_Y2_General.rds")


#------------------------------------ 10 BINS

pdf(file = "UnicoModelo_CaibrationlPlot_XGB-DART_Y2.pdf")


prob_test <- read.csv("vector_test_set_XGB-DART_General.csv", header = T, dec = ".")
